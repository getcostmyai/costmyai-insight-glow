  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pricing — CostMyAI" },
      {
        ...
        content:
          "Four rungs, one ladder: Compare free, then Certify, Rightsize and Govern. No provider keys, no placement fees.",
      },
