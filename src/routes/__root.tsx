...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CostMyAI — AI cost intelligence" },
      {
        name: "description",
        content: "Track AI gateway spend and activate certified, quality-checked cost switches.",
      },
      { name: "author", content: "CostMyAI" },
      { property: "og:title", content: "CostMyAI — AI cost intelligence" },
      {
